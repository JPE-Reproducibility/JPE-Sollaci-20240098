...
bootstrap sg = r(revenue_growth) sl = r(revenue_level), reps(100) seed($seed_num): assortative_match
...
noisily {
    display in red "============ Table F.1 (Company B) ============"
    list category estimate ci, noobs clean
}

export excel using ///
    "$res_dir/Tables/Table_F1_Company_B.xlsx", firstrow(variables) replace
