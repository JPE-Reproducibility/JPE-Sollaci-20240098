...
xtitle("Group rank (largest to smallest)") ytitle("Number of Managers/Stores") xlabel(1 10 20 30 40 50) ///
legend(pos(6) cols(2) lab(1 "Number of Managers") lab(2 "Number of Stores"))
graph export "$res_dir/Figures/Figure_E1_panel_B.png", width(1200) height(800) replace
...
preserve
	...
	graph export "Figure_E2_panel_C.png", width(1200) height(800) replace
	...
	graph export "Figure_E3_panel_C.png", width(1200) height(800) replace
restore
...
preserve
	...
	graph export "Figure_E2_panel_D.png", width(1200) height(800) replace
	...
	legend(pos(6) cols(3) lab(1 "Unadjusted") lab(2 "EB-Adjusted") lab(3 "Grouped")) ///
	note("Note: all fixed effects are normalized so that their average is zero within each connected set.")
	graph export "Figure_E3_panel_D.png", width(1200) height(800) replace
restore
