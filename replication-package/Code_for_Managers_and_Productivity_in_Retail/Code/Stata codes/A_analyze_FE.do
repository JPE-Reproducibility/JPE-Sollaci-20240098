...
noisily{
	display in red "============ Table 1 Column 2 ============"
...
preserve
	...
	noisily {
	display in red "============ Number of connected sets is ============"
	count
	
	display in red "============ Number of stores in largest connected sets is ============"
...
preserve
	...
	noisily {	
	display in red "============ Number of managers in largest connected sets is ============"
...
cd "$code_dir"
sort connected_set store_id time
...
graph export "$res_dir/Figures/Figure_A4_panel_A.png", width(1200) height(800) replace
...
preserve
	...
	* Figure 3
	kdensity manager_fe_eb if cs_rank == 1, lcolor(black) lwidth(medthick) ///
	...
	graph export "Figure_3_panel_A.png", width(1200) height(800) replace
	
	su manager_fe_eb if cs_rank==1, d
	...
	graph export "Figure_A2_panel_A.png", width(1200) height(800) replace
restore
...
preserve
	...
	* Figure 3
	kdensity store_fe_eb if cs_rank == 1, lcolor(black) lwidth(medthick) ///
	ytitle("Density", size(medium)) xtitle("Store Fixed Effect (EB-Adjusted)", size(medium)) title("") note("") ///
	legend(off) graphregion(color(white)) ylabel(,labsize(medium)) xlabel(,labsize(medium))
	graph export "Figure_3_panel_B.png", width(1200) height(800) replace
	
	su store_fe_eb if cs_rank== 1, d		
	...
	graph export "Figure_A3_panel_A.png", width(1200) height(800) replace
restore
...
graph export "$res_dir/Figures/Figure_4_panel_A.png", width(1200) height(800) replace
...
ytitle("Baseline") xtitle("Location-Specific Time Effects") legend(pos(6) cols(2) lab(1 "Manager Fixed Effect") lab(2 "Store Fixed Effect"))
graph export "$res_dir/Figures/Figure_C2_panel_A.png", width(1200) height(800) replace
...
graph export "$res_dir/Figures/Figure_C3_panel_B.png", width(1200) height(800) replace
...
line jm_fe jm_fe, lcolor(red) || scatter m_fe jm_fe if !mi(jm_fe), ///
	...
	graphregion(color(white)) legend(pos(6) cols(2) lab(1 "45{superscript:o} line") lab(2 "Fixed Effects") size(medium)) 
graph export "$res_dir/Figures/Figure_C3_panel_A.png", width(1200) height(800) replace



*** Is there Persistence? ***

noisily display in red "============ R2 numbers discussed in Appendix C.2 ============"
...
noisily display in red "============ Numbers in Appendix E.2 ============"
