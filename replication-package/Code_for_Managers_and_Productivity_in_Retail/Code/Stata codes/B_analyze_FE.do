...
graph export "$res_dir/Figures/Figure_A4_panel_B.png", width(1200) height(800) replace
...
preserve
	...
	* Figure 3
	...
	graph export "Figure_3_panel_C.png", width(1200) height(800) replace
	...
	graph export "Figure_A2_panel_B.png", width(1200) height(800) replace
restore
...
preserve
	...
	* Figure 3 (the following plots the densities in CS 1-4, though Figure 3 shows only the largest CS)
	...
	legend(off) graphregion(color(white)) ylabel(,labsize(medium)) xlabel(,labsize(medium))
	graph export "Figure_3_panel_D.png", width(1200) height(800) replace
	...
	graph export "Figure_A3_panel_B.png", width(1200) height(800) replace
restore
...
graph export "$res_dir/Figures/Figure_4_panel_B.png", width(1200) height(800) replace
...
graph export "$res_dir/Figures/Figure_C2_panel_B.png", width(1200) height(800) replace
