...
save_path = os.path.join(figures_dir, "Figure_D3_panel_A.png")
...
save_path = os.path.join(figures_dir, "Figure_D3_panel_B.png")
plt.savefig(save_path, dpi=300)
plt.close()
...
save_path = os.path.join(figures_dir, "Figure_D3_panel_C.png")
