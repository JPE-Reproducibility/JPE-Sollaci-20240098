...
xtitle("Group rank (larged to smallest)", size(medium)) ytitle("Number of Managers/Stores", size(medium)) xlabel(1 5 10 15 20, labsize(medium)) ///
ylabel(,labsize(medium)) legend(cols(2) pos(6) lab(1 "Number of Managers") lab(2 "Number of Stores") size(medium))
graph export "$res_dir/Figures/Figure_E1.png", width(1200) height(800) replace
...
preserve
	...
	graph export "Figure_E2a.png", width(1200) height(800) replace
	...
	graph export "Figure_E3a.png", width(1200) height(800) replace
restore
...
preserve
	...
	graph export "Figure_E2b.png", width(1200) height(800) replace
	...
	legend(pos(6) cols(3) lab(1 "Unadjusted") lab(2 "EB-Adjusted") lab(3 "Grouped") size(medium)) ///
	note("Note: all fixed effects are normalized so that their average is zero within each" "connected set.", size(medsmall))
	graph export "Figure_E3b.png", width(1200) height(800) replace
restore
